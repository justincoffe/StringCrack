...
public:
  ...
  void LaunchCosetGosperAsync(int hamming_h, int B_top, int k1, int k2, uint64_t base_rank_offset, uint64_t L_totalCombs, int chunk_size, dim3 grid, int threadsPerBlock, bool is_sparse);
